...
class HideUnhideView(ui.View):
    ...
    async def unhide(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed.set_author(name=f"Successfully Unhidden {self.channel.name}", icon_url="https://cdn.discordapp.com/attachments/1329411292532051999/1329451540028719255/Astra_X.jpeg?ex=678a63bb&is=6789123b&hm=917647b44f40b887260074c1ccc602f0b7b8f4054c18ccc5ab6a5824bf77a9aa&")
...
class Hide(commands.Cog):
    ...
    async def hide_command(self, ctx, channel: discord.TextChannel = None):
        ...
        if not channel.permissions_for(ctx.guild.default_role).read_messages:
            ...
            embed.set_author(name=f"{channel.name} is Already Hidden", icon_url="https://cdn.discordapp.com/attachments/1329411292532051999/1329451540028719255/Astra_X.jpeg?ex=678a63bb&is=6789123b&hm=917647b44f40b887260074c1ccc602f0b7b8f4054c18ccc5ab6a5824bf77a9aa&")
        ...
        embed.set_author(name=f"Successfully Hidden {channel.name}", icon_url="https://cdn.discordapp.com/attachments/1329411292532051999/1329451540028719255/Astra_X.jpeg?ex=678a63bb&is=6789123b&hm=917647b44f40b887260074c1ccc602f0b7b8f4054c18ccc5ab6a5824bf77a9aa&")
        embed.set_footer(text=f"Requested by {ctx.author}", icon_url=ctx.author.avatar.url)
        view = HideUnhideView(channel=channel, author=ctx.author, ctx=ctx) 
        message = await ctx.send(embed=embed, view=view)
        view.message = message
