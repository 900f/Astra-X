...
class Ban(commands.Cog):
    ...
    async def ban(self, ctx, user: discord.User, *, reason=None):
        ...
        if member == ctx.guild.owner:
            ...
            error.set_author(name="Error Banning User", icon_url="https://cdn.discordapp.com/attachments/1329411292532051999/1329451540028719255/Astra_X.jpeg?ex=678a63bb&is=6789123b&hm=917647b44f40b887260074c1ccc602f0b7b8f4054c18ccc5ab6a5824bf77a9aa&")
