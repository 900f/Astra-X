    ...
    async def on_message(self, message):
        ...
        if self.bot.user in message.mentions:
            if len(message.content.strip().split()) == 1:
                ...
                embed.set_footer(text="Powered by Astra Development™", icon_url=self.bot.user.avatar.url)
                ...
                buttons = [
                    ...
                    discord.ui.Button(label="Support", style=discord.ButtonStyle.link, url="https://discord.com/invite/x6kPc9d4TP"),
                ]
