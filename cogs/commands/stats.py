...
class Stats(commands.Cog):
    ...
    async def stats(self, ctx):
        processing_message = await ctx.send("<a:Loading:1328740531907461233> Loading Astra X information...")
        ...
        embed = Embed(title="Astra Statistics: General", color=0x000000)
        ...
        embed.set_footer(text="Powered by Astra X Development™", icon_url=self.bot.user.display_avatar.url)
        ...
        async def system_button_callback(interaction):
            if interaction.user == ctx.author:
                system_embed = Embed(title="Astra Statistics: System", color=0x000000)
                ...
                system_embed.set_footer(text="Powered by Astra X Development™", icon_url=self.bot.user.display_avatar.url)
        ...
        async def ping_button_callback(interaction):
            if interaction.user == ctx.author:
                ...
                ping_embed.set_footer(text="Powered by Astra X Development™", icon_url=self.bot.user.display_avatar.url)
