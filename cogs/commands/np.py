...
class NoPrefix(commands.Cog):
            ...
            if expired_users:
                ...
                for user_id in expired_users:
                    ...
                    if user:
                        ...
                        embed.set_footer(text="Astra X  - No Prefix, Join support to regain access.")
    ...
    async def add_np(self, user, duration):
        ...
        embed = discord.Embed(
                            ...
                            description=f"You've been credited 2 months of global No Prefix for boosting our Partnered Servers. You can now use my commands without prefix. If you wish to remove it, please reach out [Support Server](https://discord.gg/GtyrhxZVEU).",
                            color=0x000000
                        )
        try:
