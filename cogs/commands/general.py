...
class General(commands.Cog):
  ...
  async def invite(self, ctx: commands.Context):
    embed = discord.Embed(title="Astra X Invite & Support!",
      description=
      f"> <:icons_plus:1328966531140288524> **[Astra X - Invite Bot](https://discord.com/oauth2/authorize?client_id=1470173841283088425&permissions=8&integration_type=0&scope=bot+applications.commands)**\n> <:icons_plus:1328966531140288524> **[Astra X - Support](https://discord.gg/GtyrhxZVEU)**",
      color=0x0ba7ff)
    ...
    invite = Button(
      ...
      url=
      'https://discord.com/oauth2/authorize?client_id=1470173841283088425&permissions=8&integration_type=0&scope=bot+applications.commands'
    )
    support = Button(label='Support',
                    style=discord.ButtonStyle.link,
                    url=f'https://discord.gg/GtyrhxZVEU')
    view = View()
